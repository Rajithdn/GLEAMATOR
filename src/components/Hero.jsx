...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className="sm:px-16 px-6 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-col md:flex-row items-start gap-5 h-full">
        ...
        <div className="xl:mt-8 flex flex-row gap-10 w-full">
          ...
          <motion.div
            ...
            className="flex-1 xl:h-[550px] md:h-[600px] h-[400px] p-0 mb-4 -mt-28 flex justify-center items-center"
          >
            <EarthCanvas />
          </motion.div>
        </div>
